proc Generate_PAC_accessors {C A P var {propagate 1}} {
  ...
  append cmd "method $C set_$var {v} {
	if {\$this(abstraction) != \"\"} {\$this(abstraction) set_$var \$v};
	if {\$this(presentation) != \"\"} {\$this(presentation) set_$var \[this get_$var\]};\n"
	
	if {$propagate} {
		append cmd "this Propagate \$objName \"\$objName \set_$var \$v\"\n"
	}
	append cmd "}\n"
